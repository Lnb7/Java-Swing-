...
public class TicTacToe extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jlblPlayerX.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
    ...
    private void jbtnExitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnExitActionPerformed
        ...
        if(JOptionPane.showConfirmDialog(frame, "Confirm if you exit","TicTacToe",JOptionPane.YES_NO_OPTION)==JOptionPane.YES_NO_OPTION)
        {
            System.exit(0);
        }
